<template> 
  <div class="dark">
    ...
    <div class="side-nav side-nav-left center">
        <div class="rotate">
            <router-link to="/letter-form-anatomy">&#9650;<br />Letter-form Anatomy</router-link>
        </div>
    </div>
    <div class="side-nav side-nav-right center">
        <div class="rotate">
            <router-link to="/italics-dashes">Italics, -, &ndash;, &mdash;, and  &tilde;<br />&#9660;</router-link>
        </div>
    </div>
    ...
    <div class="content--first green clear">
      ...
      <div class="column--single">
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/01-kr-old-style.svg" alt="Korean Old Style"><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/01-en-old-style.svg" alt="English Old Style"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      <h3 class="text--light bold">Serif / Myeongjo <span class="kr-sans">(명조체)</span></h3>
                      <img class="spacer--tiny" src="/static/images/type-categories/02-kr-transitional.svg" alt="Korean Transitional"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/02-en-transitional.svg" alt="English Transitional"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      <h3 class="text--light bold">Serif / Myeongjo <span class="kr-sans">(명조체)</span></h3>
                      <img class="spacer--tiny" src="/static/images/type-categories/03-kr-modern.svg" alt="Korean Modern"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/03-en-modern.svg" alt="English Modern"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/04-kr-slab.svg" alt="Korean Slab Serif"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/04-en-slab.svg" alt="English Slab Serif"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/05-kr-humanist.svg" alt="Korean Humanist Gothic"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/05-en-humanist.svg" alt="English Humanist"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      <h3 class="text--light bold">Sans-Serif / Gothic <span class="kr-sans">(고딕체)</span></h3>
                      <img class="spacer--tiny" src="/static/images/type-categories/06-kr-geometric.svg" alt="Korean Geometric"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/06-en-geometric.svg" alt="English Geometric"><br />
                      <span class="text--light caption caps">Typeface</span><br />
          ...
          <div class="spacer--small">
                  ...
                  <div class="column--half-br-fluid center">
                      <h3 class="text--light bold">Sans-Serif / Gothic <span class="kr-sans">(고딕체)</span></h3>
                      <img class="spacer--tiny" src="/static/images/type-categories/07-kr-grotesque.svg" alt="Korean Grotesque"><br />
                      <span class="text--light caption caps">Typeface</span><br />
                  ...
                  <div class="column--half-br-fluid center">
                      ...
                      <img class="spacer--tiny" src="/static/images/type-categories/07-en-grotesque.svg" alt="English Grotesque"><br />
                      <span class="text--light caption caps">Typeface</span><br />
      ...
      <div class="spacer--medium center">
          <router-link class="button caps" to="/italics-dashes">Next Chapter</router-link>
      </div>  
    </div>
  </div>
</template>      
